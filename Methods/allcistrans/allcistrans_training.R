...
#**********           revised by Chanhwa on Oct22, 2020               **********
#**********           Version: 0.8                                    **********
#**********           Oct 22, 2020                                    **********
#*******************************************************************************
...
if (is.na(opt$e)) {
  cat("You must specify an expression(protein) file\n")
  continue = FALSE
}
if (is.na(opt$s)) {
...
if (summary(input.file)$class == "gzfile") {
  X.dosage = fread(opt$d, data.table = F, header = F)
} else {
